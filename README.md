...
### Open source
- **Maintainer** of [modernc.org/sqlite](https://gitlab.com/cznic/sqlite), the pure-Go CGo-free SQLite driver: pluggable page cache (SQLITE_CONFIG_PCACHE2), Scan hot-path performance work, DBStatus/FileControl APIs, 18 merged MRs.
